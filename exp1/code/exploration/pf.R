...
Y <- read.csv(cat("arguments", idx_Y, ".csv"), header = TRUE)
Y <- Y$x
...
#d <- gompertz@data[1:100]
#write.csv(d, file = "arguments.csv", row.names=FALSE, na="", col.names=FALSE, sep=",")